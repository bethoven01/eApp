...
public class API_Scenario1_RunTest {
    private static final Logger Log = LogManager.getLogger(API_Scenario1_RunTest.class);
    public static void main(String[] args) {
        ...
        // Run your tests
        core.run(API_Scenario1_RunTest.class);
    }
}
